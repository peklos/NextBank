...
export const getAllEmployees = async () => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось получить сотрудников';
...
export const getEmployeeById = async (employeeId) => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось получить сотрудника';
        return { data: null, error: detail };
    }
};
...
export const updateEmployee = async (employeeId, employeeData) => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось обновить сотрудника';
        return { data: null, error: detail };
    }
};
...
export const deleteEmployee = async (employeeId) => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось удалить сотрудника';
        return { data: null, error: detail };
    }
};
...
export const getAllBranches = async () => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось получить отделения';
        return { data: null, error: detail };
    }
};
...
export const updateBranch = async (branchId, branchData) => {
    try {
        ...
        const detail = err.response?.data?.detail || 'Не удалось обновить отделение';
        return { data: null, error: detail };
    }
};
...
export const getClientTransactions = async (clientId, limit = 50) => {
    try {
        const res = await axios.get(`/admin/clients/${clientId}/transactions`, { params: { limit } });
        return { data: res.data, error: null };
    } catch (err) {
