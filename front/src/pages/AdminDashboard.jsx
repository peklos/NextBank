...
const AdminDashboard = () => {
  ...
  const loadAllData = async () => {
    ...
    if (
      employeesStatsRes.data &&
      clientsStatsRes.data &&
      processesStatsRes.data
    ) {
      dispatch(
        setStats({
      ...
      <div className={styles.adminContent}>
        <header className={styles.pageHeader}>
          <div className={styles.titleSection}>
            ...
            <p className={styles.pageSubtitle}>Управление системой NextBank</p>
          </div>
        </header>
        ...
        <div className={styles.tabsContainer}>
          ...
          <button
            className={`${styles.tab} ${
              activeTab === "processes" ? styles.tabActive : ""
            }`}
        ...
        <main className={styles.tabContent}>
          ...
          {activeTab === "employees" && (
            <EmployeesTab
              ...
              onCreate={(data) => handleEmployeeCreate(data)}
    ...
    <div className={styles.overviewGrid}>
      <div className={styles.statCard}>
        ...
        <div className={styles.statValue}>
          {stats.employees.total_employees}
        </div>
        <div className={styles.statDetails}>
          <div className={styles.statDetail}>
            <span>Активных:</span>
            <span className={styles.statSuccess}>
              {stats.employees.active_employees}
            </span>
          </div>
          <div className={styles.statDetail}>
            <span>Неактивных:</span>
            <span className={styles.statWarning}>
              {stats.employees.inactive_employees}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className={styles.statCard}>
        ...
        <div className={styles.statDetails}>
          <div className={styles.statDetail}>
            ...
            <span className={styles.statWarning}>
              {stats.processes.pending_processes}
            </span>
          </div>
        </div>
      </div>
    ...
    <div className={styles.tabSection}>
      <div className={styles.sectionHeader}>
        ...
        <div className={styles.filterButtons}>
          ...
          <button
            className={`${styles.filterBtn} ${
              filterStatus === "in_progress" ? styles.filterActive : ""
            }`}
